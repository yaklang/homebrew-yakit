cask "yakit@1.2.0-1124-irify" do
  version "1.2.0-1124-irify"
  sha256 :no_check

  name "Yakit"
  desc "Cyber Security ALL-IN-ONE Platform (Release Date: 2025-11-24)"
  ...
  caveats do
    <<~EOS
      This is Yakit version #{version} (Released: 2025-11-24).
