cask "yakit@1.2.2-0309-irify" do
  version "1.2.2-0309-irify"
  sha256 :no_check

  name "Yakit"
  desc "Cyber Security ALL-IN-ONE Platform (Release Date: 2025-03-09)"
  ...
  caveats do
    <<~EOS
      This is Yakit version #{version} (Released: 2025-03-09).
