cask "yakit@1.1.0-1104-irify" do
  version "1.1.0-1104-irify"
  sha256 :no_check

  name "Yakit"
  desc "Cyber Security ALL-IN-ONE Platform (Release Date: 2025-11-04)"
  ...
  caveats do
    <<~EOS
      This is Yakit version #{version} (Released: 2025-11-04).
