cask "yakit@1.0.0-1030-irify" do
  version "1.0.0-1030-irify"
  sha256 :no_check

  name "Yakit"
  desc "Cyber Security ALL-IN-ONE Platform (Release Date: 2025-10-30)"
  ...
  caveats do
    <<~EOS
      This is Yakit version #{version} (Released: 2025-10-30).
