cask "yakit@1.2.3-0713-irify" do
  version "1.2.3-0713-irify"
  sha256 :no_check

  name "Yakit"
  desc "Cyber Security ALL-IN-ONE Platform (Release Date: 2025-07-13)"
  ...
  caveats do
    <<~EOS
      This is Yakit version #{version} (Released: 2025-07-13).
